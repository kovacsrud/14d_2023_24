      ...
      <div className="container mx-auto h-full sm:p-10">
        ...
        <header className="container px-4 lg:flex mt-10 items-center h-full lg:mt-0">
          <div className="w-full">
            <h1 className="text-4xl lg:text-6xl font-bold">Állatorvosi <span className="text-green-700">rendelő,</span> várjuk kedvencét!</h1>
            ...
            <button className="bg-green-500 text-white text-2xl font-medium px-4 py-2 rounded shadow">Tovább</button>
          </div>
        </header>
      </div>
    </div>
